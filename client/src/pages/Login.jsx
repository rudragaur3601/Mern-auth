...
const Login = () => {
    const [state, setState] = useState('Sign Up'); // Corrected state initialization
            ...
            <div className='bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm'>
                ...
                <form>
                    ...
                    <button
                        ...
                        className="w-full px-4 py-2 bg-indigo-500 text-white rounded-full"
                    >
                        {state}
                    </button>
                </form>
                {/* Correcting the ternary rendering logic */}
                {state === 'Sign Up' ? (
